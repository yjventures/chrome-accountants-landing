        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Premium Business Services to Drive Your Growth
            </h1>
            <p className="text-xl lg:text-2xl text-ca-silver leading-relaxed">
              From tax compliance to strategic planning, Chrome Accountants delivers tailored business services 
              to help you grow with confidence. Book a free strategy session today and see how our 
              Chrome Financial Health System™ can work for your business.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-ca-blue mb-6">
                Reserve Your Free Business Service Strategy Session
              </h2>
...
export default BusinessServiceBooking;
