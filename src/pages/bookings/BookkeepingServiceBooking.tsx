...
const calendlyUrl = "https://calendly.com/chromeaccountants/individual-tax-return-with-business-activities-clone?primary_color=ffb000";

const BookkeepingServiceBooking = () => {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Expert Bookkeeping Services for Your Business Success
            </h1>
            <p className="text-xl lg:text-2xl text-ca-silver leading-relaxed">
              Let Chrome Accountants keep your books accurate, compliant, and stress-free. 
              Book a free strategy session today and see how our Chrome Financial Health System™ can 
              streamline your bookkeeping and strengthen your business.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-ca-blue mb-6">
                  Reserve Your Free Bookkeeping Service Strategy Session
              </h2>
...
export default BookkeepingServiceBooking;
