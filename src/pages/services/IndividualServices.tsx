...
const META = {
  title: "Individual Services | Chrome Accountants",
  description: "Personalised individual tax return and planning services in Sydney. Chrome Accountants ensures accuracy, compliance, and maximum refunds.",
  keywords: "individual tax Sydney, personal tax return, tax accountant",
  canonical: "https://www.chromeaccountants.com.au/individual-services-chrome-accountants",
  h1: "Individual Services",
  // h2: "Personal Tax Solutions",
  firstSentence: "Our Individual Services are key components of our proprietary Chrome Financial Health System™, delivered by a team that acts as your dedicated financial champion and translator.",
      ...
      <section className="py-20 text-white bg-cover" style={{ backgroundImage: "url('/images/paralox-mango-bg.jpg')" }}>
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <Link to="/individual-service-booking" className="inline-block min-h-[48px] min-w-[48px]">
