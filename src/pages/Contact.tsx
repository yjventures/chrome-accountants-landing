        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Get in Touch with Your Financial Champions
            </h1>
            <p className="text-xl lg:text-2xl text-ca-silver leading-relaxed">
              Ready to transform your financial management? Get in touch with your financial champions and 
              book a free strategy session to discover how our Chrome Financial Health System™ can work for you.
            </p>
          </div>
        </div>
      </section> */}
